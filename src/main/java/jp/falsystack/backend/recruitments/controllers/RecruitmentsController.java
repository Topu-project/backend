...
public class RecruitmentsController {
  ...
  @ResponseStatus(HttpStatus.OK)
  public void updateRecruitmentById(@PathVariable Long recruitmentId, @RequestBody @Validated
  UpdateRecruitmentsRequest updateRecruitments) {
    recruitmentUsecases.updateRecruitmentById(recruitmentId,
        updateRecruitments.toUpdateRecruitments());
  }
}
